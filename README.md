...
- [@adobe/lit-mobx](https://github.com/adobe/lit-mobx) - Mixin and base class for using mobx with LitElement.
...
- [lit-robot](https://github.com/matthewp/lit-robot) - LitElement integration with [Robot](https://thisrobot.life/).
